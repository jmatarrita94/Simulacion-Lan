    ...
    */
    ...
    while (server > 0)
    {
        ...
        */
        ...
        cout << "Client: ";
        cout<<"Lo que mande: "<<buffer<<endl;
        recv(server, buffer, bufsize, 0);
        cout<<"Lo que me llego fue: "<< buffer <<endl;
        string decryptedtext = "Holi";
      ...
      /*  CryptoPP::AES::Decryption aesDecryption(key, CryptoPP::AES::DEFAULT_KEYLENGTH);
        ...
        cout<<"kkegoa"<<endl;
        stfDecryptor.Put( reinterpret_cast<const unsigned char*>( buffer ), CryptoPP::StreamTransformationFilter::NO_PADDING );
        stfDecryptor.MessageEnd();*/

        cout<<"Lo que voy a responder es: "<<decryptedtext<<endl;

        send(server, decryptedtext.c_str(), bufsize, 0);
      /*  do {
            recv(server, buffer, bufsize, 0);
            cout << buffer << " ";
            if (*buffer == '#') {
