...
int main()
{
    ...
    char *alo = (char*)malloc(1000);
    FILE * inFile = fopen("a.txt", "rb");
  ...
  //  string ciphertext;
    ...
    */
    ...
    cout<<buffer<<"Este es el buffer"<<endl;
    int client;
    ...
    */
    ...
    char * holi = "holi";
      ...
      stfEncryptor.Put( reinterpret_cast<const unsigned char*>( buffer ), CryptoPP::StreamTransformationFilter::NO_PADDING );
      stfEncryptor.MessageEnd();
      cout<<ciphertext<<"texto cifrado"<<endl;

      st = write(client, (const void*) holi, len);


/*    cout<<"Lo que mande: "<<ciphertext<<endl;
    send(client, ciphertext.c_str(), 512, 0);
    cout<<"Lo que me llego fue: "<<buffer<<endl;
    recv(client, buffer, bufsize, 0);*/
/*
    do {
        cout << "Client: ";
